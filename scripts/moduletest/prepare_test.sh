...
BUILD_DIR=$BUILD_DIR
PARAMS="--APP_KEY=1 --CLASS_NAME=$TEST_NAME --NUM_GOSSIPERS=100 --GOSSIP_PERIOD=2000 --MAX_PEERS_SIZE=10 --HEALING_FACTOR=1 --SWAPPING_FACTOR=1"
...
generateConfigFile "$PARAMS" build/resources/conf
