...
import pl.edu.uw.mimuw.nebulostore.appcore.ObjectId;
import pl.edu.uw.mimuw.nebulostore.appcore.TransportLayerAddress;
import pl.edu.uw.mimuw.nebulostore.replicator.DirectoryEntry;
import pl.edu.uw.mimuw.nebulostore.replicator.Replicator;
import pl.edu.uw.mimuw.nebulostore.replicator.SaveException;
...
public class ReplicatorTest {
  ...
  public void testDirectoryOperations() throws SaveException {
    ...
    DirectoryEntry de1 = new DirectoryEntry("entry 1", new ObjectId("entry1key"),
                                           new TransportLayerAddress());
    replicator_.appendToDirectory(dirKey1, de1);

    DirectoryEntry de2 = new DirectoryEntry("entry 2", new ObjectId("entry2key"),
        new TransportLayerAddress());
