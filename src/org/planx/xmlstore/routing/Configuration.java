...
/**
 * A set of Kademlia configuration parameters. Default values are supplied and
 * can be changed by the application as necessary.
 **/
public class Configuration {
  ...
  /**
   * If no reply received from a node in this period (in milliseconds) consider
  ...
  /**
   * Number of times a node can be marked as stale before it is actually
   * removed.
   **/
  public int STALE = 1;
}
