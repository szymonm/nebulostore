...
public class PeerAvgAgeTest {
  ...
  public static void main(String[] args) throws InterpreterException {
    String testQuery = " FORWARD TO"
        + "  XPATH(\".//friends/friend\", LOAD (\"peerData.xml\" ), TRUE )"
        + " GATHER"
        + "  LET peerData = LOAD (\"peerData.xml\" ) "
        + "  LET peerAge = IF(LEAF_EXECUTION, XPATH_NOISE(\".//age/value\", peerData, FALSE), XPATH(\".//age/value\", peerData, FALSE)) "
    ...
    state = interpreter.runGather(preparedQuery,
        interpreter.runForward(preparedQuery, state));
